/**
 * projectName: GZ
 * fileName: BeanToMapUtils.java
 * packageName: com.gzsys.common.util
 * date: 2018-02-26 13:38
 ...
 * @packageName: com.gzsys.common.util
 * @description: 实体类转Map工具类
 * @data: 2018-02-26 13:38
 **/
public class BeanToMapUtils {
    ...
    public static void main(String[] args) {
        ...
        UserBase p = new UserBase();
        p.setId("121212");
        p.setMobile("121212121");
        @SuppressWarnings("unchecked")
        Map<Object, Object> m = toMap(p);
        UserBase p2 = toBean(UserBase.class, m);
